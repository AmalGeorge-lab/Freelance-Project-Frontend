...
const FreelancerGigPage = () => {
  ...
  if(isSuccess){
    gigInfo = (
      <section className="flex flex-col w-md gap-y-5 shadow-[-6px_6px_15px_rgba(0,0,0,0.5)] p-4 rounded-xl">
  ...
  if(reviewFetchSuccess && reviewsData.length){
    reviews = (
      <section className="flex flex-col gap-y-4 shadow-[-6px_6px_15px_rgba(0,0,0,0.5)] p-4 rounded-xl w-md">
